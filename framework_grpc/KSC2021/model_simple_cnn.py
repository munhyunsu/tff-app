...
class FLModel(model.Model):
    def __init__(self, **kwargs):
        self.name = 'SIMPLE-CNN-32-32-3'
        self.label = ['Airplane', 'Ankle boot', 'Automobile', 'Bag', 'Bird', 'Cat', 'Coat', 'Deer', 'Dog', 'Dress', 'Frog', 'Horse', 'Pullover', 'Sandal', 'Ship', 'Shirt', 'Sneaker', 'T-shirt', 'Trouser', 'Truck']
