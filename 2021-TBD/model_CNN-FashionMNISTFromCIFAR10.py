...
class FLModel(model.Model):
    def __init__(self, **kwargs):
        self.name = 'CNN-FashionMNISTF'
        self.label = ['T-shirt', 'Trouser', 'Pullover', 'Dress', 'Coat', 'Sandal', 'Shirt', 'Sneaker', 'Bag', 'Ankle boot']
        ...
        fork_model = tf.keras.models.load_model('./models/cifar10/v0.0.51')
